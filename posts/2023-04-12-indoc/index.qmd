...
#   group_by(Class, year) |> 
#   summarize(n = sum(no_patent, na.rm = T)) |> 
#   ggplot(aes(x = year, y = log(n+1), group = Class, color = Class)) +
#   geom_line() +
#   scale_x_continuous(limits = c(1995, 2020)) +
#   labs(y = "Logged number of patents", x = "Year") +
#   theme(legend.position = "top",
#         legend.title = element_blank()) -> no_patent_year_ln
# no_patent_year_ln
```
